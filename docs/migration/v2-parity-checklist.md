...
| --- | ---------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- | ----------- | ------------ |
| ☐   | `/` landing (`routes/index.tsx`, `components/landing/*`, `components/map/*`) | Hero, work gallery, barbers, services + detail, hiring, locations map (lazy MapLibre), CTA, footer, scroll FX     | 06.1        |              |
| ☐   | Installed-PWA redirect (active user on `/` → `/account`)                     | Redirect logic + test                                                                                             | 06.1        |              |
